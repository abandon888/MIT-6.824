...
func TestReElection2A(t *testing.T) {
	...
	Debug(dLog2, "S%v disconnected", leader1)
	cfg.checkOneLeader()
	...
	cfg.connect(leader1)
	Debug(dLog2, "S%v reconnected", leader1)
	...
	Debug(dLog2, "S%v reconnected", (leader2+1)%servers)
	cfg.checkOneLeader()

	// re-join of last node shouldn't prevent leader from existing.
	cfg.connect(leader2)
	Debug(dLog2, "S%v reconnected", leader2)
	cfg.checkOneLeader()
